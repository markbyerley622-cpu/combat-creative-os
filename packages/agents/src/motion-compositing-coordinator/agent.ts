...
import { MotionCompositingCoordinatorInputSchema, MotionCompositingCoordinatorResultSchema } from './schema';

const FUTURE_MILESTONE = 'M9 — Compositing & rough edit (needs MotionGraphicsProvider + DesignProvider wiring)';
...
export const motionCompositingCoordinatorAgent = defineAgent({
  ...
  description: 'Plans After Effects/Figma compositing per shot. Not implemented — see futureMilestone.',
  implemented: false,
