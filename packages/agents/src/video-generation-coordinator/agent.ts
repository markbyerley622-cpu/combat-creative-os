...
import { VideoGenerationCoordinatorInputSchema, VideoGenerationCoordinatorResultSchema } from './schema';

const FUTURE_MILESTONE = 'M6 — Video generation (needs a real video-gen provider dispatch/budget contract)';
...
export const videoGenerationCoordinatorAgent = defineAgent({
  ...
  description: 'Plans generation-job dispatch across shots/providers. Not implemented — see futureMilestone.',
  implemented: false,
